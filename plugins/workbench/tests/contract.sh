...
expected_supported = {
    ...
    "cleanup_journal_contracts": [
        "workbench-task-removal-plan/v1", "workbench-task-cleanup-journal/v1",
        "workbench-task-quarantine-authority/v1", "workbench-task-quarantine-receipt/v1",
    ],
...
assert value["quarantine_authority"] == {
...
assert len(value["quarantine_authority"]["quarantine_locator"].rsplit("/", 1)[1]) == 64
assert value["quarantine_receipt"] is None
...
value = {
    ...
    "workspace_device": "16777230",
    "workspace_inode": "123456",
    "workspace_tree_digest": "sha256:" + "4" * 64,
