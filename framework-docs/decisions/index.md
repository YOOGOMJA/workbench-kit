...
| Workbench v2 governance contracts | Generic lifecycle, policy, evidence, state, and pack contracts with explicit compatibility | Accepted | [0024](0024-workbench-v2-governance.md) |
