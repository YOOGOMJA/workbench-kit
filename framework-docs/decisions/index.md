...
| Workbench v2 governance contracts | Generic lifecycle, closed authority/home inventory, terminal writer reconciliation, exact CLI/state/pack contracts | Accepted | [0024](0024-workbench-v2-governance.md) |
...
| 주제 | 선택 | 대체 → |
|---|---|---|
| [Workbench separation architecture](0018-separation-architecture.md) | Framework/profile/knowledge as one classification | [0024](0024-workbench-v2-governance.md) |
